//
//  FontAwesomeWrapper.swift
//  TestUIView
//
//  Created by Steve Lu on 10/11/16.
...
public class FontAwesomeWrapper {
    let faMap: Dictionary = ["fa-adjust" : "\u{f042}"
//        ,"fa-adn" : "\u{f170}"
...
//    ,"fa-youtube-play" : "\u{f16a}"
    ...
    func symbolCode(_ fa_name: String) -> String {
        return symbolCode(fa_name, defaultCode: "\u{f059}")
    }
    func symbolCode(_ fa_name: String, defaultCode: String) -> String {
        var rv: String? = faMap[fa_name]
        if rv == nil {
            rv = defaultCode
        }
        return rv!
    ...
    func fontAwesomeAttributedString(name: String, iconSize: CGFloat) -> NSMutableAttributedString {
            
        // Initialise some variables
        let code = symbolCode(name)
        
        
        let rv = NSMutableAttributedString(string: code,
                                           attributes: [NSFontAttributeName:UIFont(name:"FontAwesome", size: iconSize)!])
